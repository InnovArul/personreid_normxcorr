        ...
        if file ~= "." and file ~= ".." then
            ...
            if attr.mode == "directory" then
                ...
                for index = 1, 2 do
                    ...
                    rangeHeight = 0.05 * height;
                    rangeWidth = 0.05 * width;
                    randomWidth = getRandomNumber(-rangeWidth, rangeWidth)
                    randomHeight = getRandomNumber(-rangeHeight, rangeHeight)
...
---------------------------------------------------------------
-- Call augmentImages() to augment the data in labeled and detected dataset
for i = 1, #source do
    currentSource = source[i];
    augmentImages(currentSource)
end
